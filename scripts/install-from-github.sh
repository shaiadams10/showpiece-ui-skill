...
REPO="${REPO:-shaiadams10/animated-showcase-ui-skill}"
REF="${REF:-main}"
...
SOURCE_SKILL="$SOURCE_ROOT/.agents/skills/animated-showcase-ui"

if [[ ! -f "$SOURCE_SKILL/SKILL.md" ]]; then
  echo "Downloaded archive did not contain .agents/skills/animated-showcase-ui/SKILL.md" >&2
  exit 1
fi

CODEX_DEST="$TARGET_PROJECT/.agents/skills/animated-showcase-ui"
...
if [[ "$SKIP_ANTIGRAVITY_CLI_MIRROR" != "1" ]]; then
  CLI_DEST="$TARGET_PROJECT/.agent/skills/animated-showcase-ui"
