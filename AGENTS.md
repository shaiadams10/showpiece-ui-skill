...
This repository owns the `demo-ui-craft` skill. Keep it repo-local.

- Canonical skill path: `.agents/skills/demo-ui-craft`
...
- For Antigravity CLI project-local discovery, sync the canonical skill to `.agent/skills/demo-ui-craft` with `scripts/install-local-skill.ps1`.

## Editing The Skill

- Edit the canonical copy under `.agents/skills/demo-ui-craft` only.
...
- `.agents/skills/demo-ui-craft/references/visual-taxonomy.md`
- `.agents/skills/demo-ui-craft/references/visual-language.md`
- `.agents/skills/demo-ui-craft/references/component-bank.md`

## Packaging

- `package.json` exposes the public `npx github:shaiadams10/demo-ui-craft-skill` installer through `scripts/install-npx.cjs`.
...
- Use `scripts/package-skill.ps1` to build `dist/demo-ui-craft-skill.zip` from the canonical skill.
