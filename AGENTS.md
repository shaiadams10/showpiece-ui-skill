...
This repository owns the `showpiece-ui` skill. Keep it repo-local.

- Canonical skill path: `.agents/skills/showpiece-ui`
...
- For Antigravity CLI project-local discovery, sync the canonical skill to `.agent/skills/showpiece-ui` with `scripts/install-local-skill.ps1`.

## Editing The Skill

- Edit the canonical copy under `.agents/skills/showpiece-ui` only.
...
- `.agents/skills/showpiece-ui/references/visual-taxonomy.md`
- `.agents/skills/showpiece-ui/references/visual-language.md`
- `.agents/skills/showpiece-ui/references/component-bank.md`

## Packaging

- `package.json` exposes the public `npx github:shaiadams10/showpiece-ui-skill` installer through `scripts/install-npx.cjs`.
...
- Use `scripts/package-skill.ps1` to build `dist/showpiece-ui-skill.zip` from the canonical skill.
